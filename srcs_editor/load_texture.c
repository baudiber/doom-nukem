...
void		load_floor_texture(t_env *e)
{
	if (!(e->texture.image[12] = SDL_LoadBMP("textures/floors/JOLI.bmp")))
		exit_error(2, ERR_2);
	if (!(e->texture.image[13] = SDL_LoadBMP("textures/floors/TROU.bmp")))
		exit_error(2, ERR_2);
	if (!(e->texture.image[14] = SDL_LoadBMP("textures/floors/IS_LAVA.bmp")))
		exit_error(2, ERR_2);
	if (!(e->texture.image[15] = SDL_LoadBMP("textures/floors/CEILING.bmp")))
		exit_error(2, ERR_2);
	if (!(e->texture.image[16] = SDL_LoadBMP("textures/floors/CRACKLED.bmp")))
		exit_error(2, ERR_2);
}
...
void		load_sprite_texture(t_env *e)
{
	if (!(e->texture.image[17] = SDL_LoadBMP("textures/editor_textures/player_spawn.bmp")))
		exit_error(2, ERR_2);
	if (!(e->texture.image[18] = SDL_LoadBMP("textures/editor_textures/SARGE.bmp")))
		exit_error(2, ERR_2);
	if (!(e->texture.image[19] = SDL_LoadBMP("textures/editor_textures/item_shotgun.bmp")))
		exit_error(2, ERR_2);
}
