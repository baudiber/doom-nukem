...
/*   Updated: 2019/04/12 18:04:51 by roddavid         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void		ft_slider_2(t_env *e, int x)
{
	...
	//	Mix_Volume(5, 128 * 0.025);
	//	Mix_Volume(6, 128 * 0.025);
	}
	if (x >= 421 && x <= 477)
	{
		if (e->menu.i_img >= 4 && e->menu.i_img <= 8)
	...
	//	Mix_Volume(5, 128 * 0.05);
	//	Mix_Volume(6, 128 * 0.05);
	}
	if (x >= 478 && x <= 533)
	{
		if (e->menu.i_img >= 4 && e->menu.i_img <= 8)
		...
		Mix_Volume(-1, 128 * 1);
	//	Mix_Volume(5, 128 * 0.10);
	//	Mix_Volume(6, 128 * 0.10);
	}
}
...
void		ft_slider(t_env *e, int x, int y, SDL_Event ev)
{
	if (y >= 440 && y <= 485 && ev.button.button == SDL_BUTTON_LEFT)
	{
		...
		//	Mix_Volume(5, 128 * 0.01);
		//	Mix_Volume(6, 128 * 0.01);
		}
		ft_slider_2(e, x);
	}
}
